...
void EffMacroDijetsTrigger::Run(std::string filein_, std::string savehistofile_, std::string processname_, double jet1PT_, double jet2PT_, int triggereffpass_, double sumEHFPlus_, double sumEHFMinus_, int optTrigger_, bool switchSelJet1Eff_, bool switchSelJet2Eff_, bool switchSelDijetsEff_, bool switchSelHFPlusEff_, bool switchSelHFMinusEff_, bool switchSelHFOREff_, bool switchSelHFANDEff_){
 ...
 TFile check1(filein.c_str());
   ...
   TH1F* hSumEHFPlus = new TH1F("HLTExclANDVsSumEHFPlus","HLTExclAND Vs HF^{+} - Sum of Energy;#sum E_{HF^{+}} [GeV]; Efficiency",80,0.,200.);
   TH1F* hSumEHFMinus = new TH1F("HLTExclANDVsSumEHFMinus","HLTExclAND Vs HF^{-} - Sum of Energy;#sum E_{HF^{-}} [GeV]; Efficiency",80,0.,200.);
   ...
   TH1F* hLeadingJetPt = new TH1F("HLTExclANDVsJet1Pt","HLTExclAND Vs Leading Jet - P_{T};P_{T} Jet1 [GeV.c^{-1}]; Efficiency ",80,0.,400.);
   TH1F* hSecondJetPt = new TH1F("HLTExclANDVsJet2Pt","HLTExclAND Vs Second Jet - P_{T};P_{T} Jet2 [GeV.c^{-1}]; Efficiency ",80,0.,400.);
