...
EventMacro::LoadFiles(int entering)
{
  ...
  AutoLibraryLoader::enable();
   ...
   OpenPattuple("/storage2/dmf/Common/OutputFiles/MCPompty/pomptyMinusAll.root");
   
   cout << "\n MC Sample: PomptyMinus All GeV/c\n" << endl;
   
   RunExclusive("hltexcldijet30Uand-pomptyMinus.root",60,60,1,0, false, true, false, 104.22112155,1.0);
   RunExclusive("hltexcldijet30Uor-pomptyMinus.root",60,60,1,1, false, true, false, 44.6986477, 1.0 );
   RunExclusive("hltexcld30U-pomptyMinus.root",60,60,1,2, false, true, false,0.08646061655,  1.0);
  ...
  if (entering == 2) {
   ...
   RunExclusive("hltexcldijet30Uand-pomptyPlus.root",60,60,1,0, false, true, false, 104.22112155,1.0);
   RunExclusive("hltexcldijet30Uor-pomptyPlus.root",60,60,1,1, false, true, false, 44.6986477, 1.0 );
   RunExclusive("hltexcld30U-pomptyPlus.root",60,60,1,2, false, true, false,0.08646061655,  1.0);
