...
EventMacro::LoadFiles(int entering)
{
  ...
  AutoLibraryLoader::enable();
   ...
   OpenPattuple("/storage2/dmf/Common/OutputFiles/MCExume/signal_exume.root");
   
   cout << "\n MC Sample: ExHume  GeV/c\n" << endl;
   
   RunExclusive("hltexcldijet30Uand-exHume.root",60,60,1,0, false, true, false, 0.074335749235474,1.0);
   RunExclusive("hltexcldijet30Uor-exHume.root",60,60,1,1, false, true, false,0.031881325178389, 1.0 );
   RunExclusive("hltexcld30U-exHume.root",60,60,1,2, false, true, false,0.000061668063201,  1.0);
  ...
  // OpenPattuple("/storage2/dmf/Common/OutputFiles/MCPompty/pomptyPlusAll.root");

  // cout << "\n MC Sample: PomptyPlus All GeV/c\n" << endl;

   //RunExclusive("Output_MC_Pythia6/hltexcldijet30Uand-pomptyPlus.root",60,60,1,0, false, true, false, 104.22112155,1.0);
   //RunExclusive("Output_MC_Pythia6/hltexcldijet30Uor-pomptyPlus.root",60,60,1,1, false, true, false, 44.6986477, 1.0 );
   //RunExclusive("Output_MC_Pythia6/hltexcld30U-pomptyPlus.root",60,60,1,2, false, true, false,0.08646061655,  1.0);
...
//0.47445320115444	0.20348482316385	0.000393600794981   
 ...
 //0.098512792205911	0.042250443357998	0.00008172505367
   ...
   RunExclusive("Output_MC_Pythia6/hltexcldijet30Uand-qcd_15to3000.root",60,60,1,0, true, true, false, 139601.572499861, 1.0);
   RunExclusive("Output_MC_Pythia6/hltexcldijet30Uor-qcd_15to3000.root",60,60,1,0, true, true, false, 59872.7149999406, 1.0);
   RunExclusive("Output_MC_Pythia6/hltexcld30-qcd_15to3000.root",60,60,1,0, true, true, false, 115.811822499885, 1.0);
   //139601.572499861	59872.7149999406	115.811822499885
   }
*/
}
