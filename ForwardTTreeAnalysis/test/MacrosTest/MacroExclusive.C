...
// FWLite libraries
  ...
  // Loading Files
  TFile *inf  = TFile::Open("/storage2/dmf/Common/OutputFiles/PatSamples2010/PATTupleMultiJets2010.root");
...
RunExclusive(60,60,1,0);
RunExclusive(30,15,2,1);

}

void RunExclusive(double jet1PT, double jet2PT, int optnVertex, int optTrigger)
{
