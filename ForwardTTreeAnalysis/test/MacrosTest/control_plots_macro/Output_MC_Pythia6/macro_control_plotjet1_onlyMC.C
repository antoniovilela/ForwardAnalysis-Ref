...
//  TFile *d = new TFile("/storage2/dmf/Common/OutputFiles/MacroOutPut/data2010/data_2010_HFAND30.root");  
  ...
  //  /////////////////////////////////////////////////////
   a.cd("");
   TH1F *hptDiffa = (TH1F*)pTJet1wc->Clone();
 
   hptDiffa->SetName("pTJet1wc");
 ...
 //  /////////////////////////////////////////////////////
  b.cd("");
  TH1F *hptDiffb = (TH1F*)pTJet1wc->Clone();
 
  hptDiffb->SetName("pTJet1wc");
...
//////////////////////////////////////////////	
 ...
 /////////////////////////////////////////////////////
  c.cd("");
  TH1F *hptDiffc = (TH1F*)pTJet1wc->Clone();
  hptDiffc->SetName("pTJet1wc");
...
///////////////////////////////////////////
 /////////////////////////////////////////////////////
/*  d.cd("");
 TH1F *hptDiffd = (TH1F*)pTJet1wc->Clone();
 hptDiffd->SetName("pTJet1wc");
...
///////////////////////////////////////////
  ...
  leg->Draw();
  c1->SaveAs("PtJet1_wc_onlyMC.png");
