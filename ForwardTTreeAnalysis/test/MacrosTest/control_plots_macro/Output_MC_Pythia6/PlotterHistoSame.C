...
cout << "\nRunning...\n" << endl;
Plotter ("hltexcld30U-qcd_15to30.root",
         "/storage2/sfonseca/CMSSW/pompty_exhume_plots/CMSSW_4_2_8/src/ForwardAnalysis/ForwardTTreeAnalysis/test/MacrosTest/exHume/hltexcldijet30Uand-exHume.root",
         "/storage2/sfonseca/CMSSW/pompty_exhume_plots/CMSSW_4_2_8/src/ForwardAnalysis/ForwardTTreeAnalysis/test/MacrosTest/pompty/hltexcldijet30Uand-pomptyPlusMinus.root",
         "/storage2/dmf/Common/OutputFiles/MacroOutPut/data2010/data_2010_HFAND30.root",
         "excldijet30And");
}
