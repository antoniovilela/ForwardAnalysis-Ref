...
if config.runOnMC:
    ...
    #config.hltPaths = ('HLT_Jet30*','HLT_Jet60*','HLT_Jet80*','HLT_Jet110*','HLT_Jet150*','HLT_Jet190*','HLT_Jet240_v*','HLT_Jet370_v*')
    #config.hltPaths = ('HLT_Jet30*','HLT_Jet60*','HLT_Jet80*','HLT_Jet110*','HLT_Jet150*','HLT_Jet190*','HLT_Jet240_v*','HLT_Jet370_v*')
    config.hltPaths = ('HLT_ExclDiJet80_HFAND_v*','HLT_ExclDiJet35_HFAND_v*','HLT_ExclDiJet35_HFOR_v*','HLT_L1SingleJet16_v*','HLT_DiPFJetAve80_v*','HLT_L1SingleJet36_v*')    

#config.generator = 'Pythia6'

#config.outputEdmFile = 'teste.root'
...
if config.runOnMC:
    ...
    #process.exclusiveDijetsHLTFilter.HLTPaths = config.hltPaths 
    process.exclusiveDijetsHLTFilter.HLTPaths =['HLT_L1SingleJet16_v*']
...
process.forwardQCDTTreeAnalysis = cms.EDAnalyzer('ProcessedTreeProducer',
    ...
    triggerName     = cms.vstring('HLT_PFJet40_v3','HLT_PFJet80_v3','HLT_PFJet140_v3','HLT_PFJet200_v3','HLT_PFJet260_v3',
                                  'HLT_PFJet320_v3','HLT_PFJet400_v3'),
