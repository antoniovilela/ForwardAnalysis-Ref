...
sewhitelist = ''
output = 'TEST.root'
triggersmc =  "'HLT_Jet30_v*','HLT_Jet60_v*', 'HLT_DiJetAve15U_v*', 'HLT_DiJetAve30U_v*', 'HLT_DiJetAve50U_v*', 'HLT_ExclDiJet60_HFAND_v*','HLT_ExclDiJet60_HFOR_v*'"
triggersdata = "'HLT_Jet30_v*','HLT_Jet60_v*', 'HLT_DiJetAve15U_v*', 'HLT_DiJetAve30U_v*', 'HLT_DiJetAve50U_v*', 'HLT_ExclDiJet60_HFAND_v*','HLT_ExclDiJet60_HFOR_v*'"
mail='dmf@cern.ch'
...
userremotedir = '/pattuple-crab_QCD_Pt-15to3000-Z2'
lumixs = ''
nevent ='10000000'
ejob = '10000'
#sewhitelist = 'T2_DE_DESY'
