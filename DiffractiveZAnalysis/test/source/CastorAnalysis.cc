...
void CastorAnalysis::FillHistos(int index, int pileup, double totalweight){
  ...
  for (l=0; l<16;l++){
    if (eventdiffZ->GetCastorTowerEnergy(l) > 10.){
      ++SectorCastorHit;
  ...
  if (eventdiffZ->GetCastorTowerEnergy(0) > 10.){
  ...
  if (eventdiffZ->GetCastorTowerEnergy(1) > 10.){
  ...
  if (eventdiffZ->GetCastorTowerEnergy(2) > 10.){
  ...
  if (eventdiffZ->GetCastorTowerEnergy(3) > 10.){
  ...
  if (eventdiffZ->GetCastorTowerEnergy(4) > 10.){
  ...
  if (eventdiffZ->GetCastorTowerEnergy(5) > 10.){
  ...
  if (eventdiffZ->GetCastorTowerEnergy(6) > 10.){
  ...
  if (eventdiffZ->GetCastorTowerEnergy(7) > 10.){
  ...
  if (eventdiffZ->GetCastorTowerEnergy(8) > 10.){
  ...
  if (eventdiffZ->GetCastorTowerEnergy(9) > 10.){
  ...
  if (eventdiffZ->GetCastorTowerEnergy(10) > 10.){
  ...
  if (eventdiffZ->GetCastorTowerEnergy(11) > 10.){
  ...
  if (eventdiffZ->GetCastorTowerEnergy(12) > 10.){
  ...
  if (eventdiffZ->GetCastorTowerEnergy(13) > 10.){
  ...
  if (eventdiffZ->GetCastorTowerEnergy(14) > 10.){
  ...
  if (eventdiffZ->GetCastorTowerEnergy(15) > 10.){
